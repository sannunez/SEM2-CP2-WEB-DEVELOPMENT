...
export default function Contact() {
    ...
    <>
        <body className="gap-10 max-w-[1024px] h-[90vh] mx-[auto] flex justify-center items-center">
            ...
            <div className="w-[45%] h-[70%] relative flex justify-center items-center bg-[url('../../src/assets/images/form-deco.svg')] bg-contain bg-no-repeat bg-center">
                {/* <img src="../../src/assets/images/form-deco.svg" alt="form-decoration" className="absolute w-[100%] h-[100%] z-[-1]"/> */}
                <div className="bg-[#d9d9d9] w-[70%] h-[85%] rounded-[15px] flex justify-center items-center">
